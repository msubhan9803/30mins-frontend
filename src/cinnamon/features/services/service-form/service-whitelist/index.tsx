...
export default function ServiceWhitelit({
  handleChange,
  serviceWhitelist,
  ...
  return (
    <>
      <BinaryRadio
        question={t('whitelist_question')}
        description={t('whitelist_description')}
        icon={<ShieldCheckIcon className='w-6 h-6' />}
        errors={errors.serviceWhitelist}
        collapsed={serviceWhitelist === 'yes'}
        value={serviceWhitelist}
        field='serviceWhitelist'
        ...
        <>
          ...
          <div className='flex flex-col md:flex-row gap-x-6'>
            ...
            <div className='flex flex-col w-full md:w-1/3 mt-6 md:mt-0 flex-grow'>
              ...
              <div className='flex-grow w-full flex items-start gap-4 p-4 flex-wrap min-h-[96px] rounded-lg border border-gray-300 mt-4'>
                {serviceWhitelistEmails &&
