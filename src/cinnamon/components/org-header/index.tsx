...
export default function OrgHeader({organizationDetails}) {
  ...
  return (
    <div className='my-6 container mx-auto flex flex-col lg:flex-row items-start lg:items-center justify-between'>
      <div className='bg-white  shadow rounded xl:flex lg:flex w-full '>
        <div className='xl:w-2/5 lg:w-2/5 bg-gray-100  py-8 border-gray-300  xl:border-r rounded-tl xl:rounded-bl rounded-tr xl:rounded-tr-none lg:border-r-2 border-b xl:border-b-0 flex justify-center items-center'>
          <div className='flex flex-col items-center'>
            <div className='flex items-center justify-center'>
              <img
                className='h-36 w-36 object-contain object-center rounded-xl'
                src={
          ...
          {organizationDetails?.media?.type === 'Youtube Embed' && (
            <div className='relative flex w-full h-max overflow-hidden rounded-md'>
              <ReactPlayer
                height={'350px'}
                width={'100%'}
                url={`${organizationDetails?.media?.link}`}
              />
            </div>
          )}
        ...
        <div className='lg:w-3/6 flex flex-col min-h-full px-6 py-4'>
          ...
          <div className='mt-auto flex flex-row gap-2 w-full'>
            <a className='w-full' href={`${publicUrl}members`}>
              <Button variant='ghost' className='w-full justify-center' onClick={() => {}}>
                {t('common:Members')}
              </Button>
            </a>
            <a className='w-full' href={`${publicUrl}services`}>
              <Button variant='solid' className='w-full justify-center' onClick={() => {}}>
                {t('common:services')}
              </Button>
            </a>
          </div>
