...
export default function TagElement({value, onRemove}) {
  ...
  return (
    <Transition
      ...
      className='p-2 border gap-2 w-24 hover:shadow shadow-inner shadow-gray-100 flex flex-row justify-between min-w-max items-center rounded-3xl h-max'
    >
