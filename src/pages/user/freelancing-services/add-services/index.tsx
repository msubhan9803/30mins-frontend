...
const AddService = ({userStripeAccount}) => {
  ...
  const crumbs = [
    ...
    {title: tpage('Freelancing Services'), href: '#'},
    {
      ...
      href:
        mode === 'create'
          ? '/user/freelancing-services/add-services/?mode=create&stepType=FREELANCING_WORK'
          : `/user/freelancing-services/add-services/?mode=edit&sid=${sid}`,
    },
  ];
  ...
  return (
    <PostLoginLayout className='pb-28 mb-10'>
      ...
      <Header
        crumbs={crumbs}
        heading={`${mode === 'create' ? t('add') : t('edit')} ${serviceType}`}
      />
      {moreOptions && (
        <MoreOptions
            ...
            <Transition step={step} show={created}>
              <div className='flex flex-col items-center justify-center'>
                ...
                <div className='flex gap-4 mt-4'>
                  ...
                  <Button
                    onClick={() =>
                      router.push('/user/freelancing-services/all-freelancing-services')
                    }
                    variant='outline'
                  >
                    {t('go_to_services')}
