...
import {CredentialsError, OrgError, OrgExtentionError} from '@root/components/error';
...
const AddService = ({userStripeAccount}) => {
  ...
  const crumbs = [
    {title: t('home'), href: '/'},
    {title: t('services'), href: '/user/services'},
  ];
  ...
  if (loading || (!values.serviceType && sid)) {
    return (
      <PostLoginLayout>
        <Header crumbs={crumbs} heading='Add New Service' />
        <SecLoader />
      </PostLoginLayout>
    );
  }
  ...
  if (hasCalendar === 'no') {
    return (
      <PostLoginLayout>
        <Header crumbs={crumbs} heading='Add New Service' />
        <CredentialsError router={router} />
      </PostLoginLayout>
    );
  }
            ...
            <Transition step={step} show={created}>
              <div className='flex flex-col items-center justify-center'>
                ...
                <div className='flex gap-4 mt-4'>
                  ...
                  <Button onClick={() => router.push('/user/services')} variant='outline'>
                    {t('go_to_services')}
                  </Button>
                </div>
              </div>
