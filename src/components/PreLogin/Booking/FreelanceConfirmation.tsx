...
export default function FreelanceConfirmation({user, serviceData, paymentInvoice, selectedDate}) {
    ...
    <>
      <div className='grid  tracking-wide h-full '>
        <div className='py-20 place-self-center items-center md:py-3'>
          <div className='flex flex-col gap-2 justify-items-center px-10 py-10 bg-white rounded-lg shadow-lg hover:shadow-inner'>
            <div>
            ...
            <div className='flex flex-col gap-2 text-center'>
              ...
              <div className='flex flex-col gap-2 '>
                ...
                >
                  {t('common:send')}{' '}
                  <span className='font-semibold'> {user?.personalDetails?.name}</span>{' '}
                  {t('common:an_email')}
                </Button>
                <Link
                  href={{
