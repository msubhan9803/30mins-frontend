...
const SearchForm = (props: IProps) => {
  const {setSearchFilter, isLoading} = props;
  ...
  return (
    ...
    >
      {({values}) => (
        <Form className=''>
          <div className='mx-4 sm:mx-6 lg:mx-8 sm:px-6 lg:px-8 col-span-12 flex gap-2 flex-wrap justify-center sm:justify-start'>
            <Field
              type='text'
              name='keywords'
