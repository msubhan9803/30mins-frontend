...
export default function CollapseButton({onToggleCollapse, collapseClick}: Props) {
  ...
  return (
    <>
      <div
        className='hover:bg-gray-100 w-10 h-10 rounded-full items-center justify-center'
        onClick={onToggleCollapse}
      >
        <div
          className={`w-10 h-10 rounded-full flex justify-center items-center transition-transform duration-150 
          hover:scale-110 focus:border-sky-500 
