...
export default function ManageNewService({
  values: ParentValue,
      ...
      {({
        ...
        return (
          <Form action='#' className='mx-2 duration h-full overflow-y-auto'>
            <>
              <div className='w-full flex flex-col justify-center items-end gap-2 p-2 sm:p-4'>
                <div className='grid w-full sm:w-max grid-cols-2 gap-2'>
                  <Button
