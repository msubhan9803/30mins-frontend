...
export default function SendButtonChat({
  ...rest
}: React.DetailedHTMLProps<React.ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement>) {
  return (
    <button
      className='text-mainBlue border-0 mx-auto 
          py-2 px-2 text-sm font-medium underline 
          active:no-underline w-12 h-12 bg-mainBlue active:bg-white
    ...
    >
      <svg
        ...
        width='820.000000pt'
        height='844.000000pt'
        viewBox='0 0 820.000000 844.000000'
        preserveAspectRatio='xMidYMid meet'
        className='w-[75%] h-[75%]  first:fill-white group-active:first:fill-mainBlue '
      >
        <g transform='translate(0.000000,844.000000) scale(0.100000,-0.100000)' stroke='none'>
          <path
            d='M211 8018 c0 -7 159 -805 352 -1773 l352 -1760 70 -7 c39 -4 203 -14
